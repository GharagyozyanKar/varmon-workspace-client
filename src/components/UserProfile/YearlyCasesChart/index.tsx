...
import type { IYearlyData } from "../../../types";
...
interface IProps {
  yearlyCasesCount: IYearlyData[],
  loading: boolean
}

const YearlyCasesChart = ({ yearlyCasesCount, loading }: IProps) => {
      ...
      <div className={styles.chartWrapper}>
        {loading ? (
          ...
          <ResponsiveContainer width="100%" height={300}>
            <BarChart
              data={yearlyCasesCount as IYearlyData[]}
